...
对于x点(坐标为(x1,x2,x3,...,xn))和 y点（坐标为(y1,y2,y3,...,yn)），两者的欧式距离为 [![d(x,y)={\sqrt  {(x_{1}-y_{1})^{2}+(x_{2}-y_{2})^{2}+\cdots +(x_{n}-y_{n})^{2}}}={\sqrt  {\sum {{i=1}}^{n}(x{i}-y_{i})^{2}}}](https://camo.githubusercontent.com/4c4d2aeda0a4e9e8569dc0ba71e480dac42db47e/68747470733a2f2f77696b696d656469612e6f72672f6170692f726573745f76312f6d656469612f6d6174682f72656e6465722f7376672f62666131383135383338313133333838643738633934303262626137333038643733346134616632)](https://camo.githubusercontent.com/4c4d2aeda0a4e9e8569dc0ba71e480dac42db47e/68747470733a2f2f77696b696d656469612e6f72672f6170692f726573745f76312f6d656469612f6d6174682f72656e6465722f7376672f62666131383135383338313133333838643738633934303262626137333038643733346134616632)
...
![K-Means æ¯è¯­å¾](https://github.com/apachecn/AiLearning/raw/dev/img/ml/10.KMeans/apachecn-k-means-term-1.jpg)
...
参考运行结果如下:
![K-Means 运行结果1](http://ml.apachecn.org/images/10.KMeans/apachecn-k-means-run-result-1.jpg)
...
在 kMeans 的函数测试中，可能偶尔会陷入局部最小值（局部最优的结果，但不是全局最优的结果）.
局部最小值的的情况如下:
![K-Means 局部最小值1](http://ml.apachecn.org/images/10.KMeans/apachecn-kmeans-partial-best-result-1.jpg)
...
运行参考结果如下:
![二分 K-Means 运行结果1](http://ml.apachecn.org/images/10.KMeans/apachecn-bikmeans-run-result-1.jpg)
